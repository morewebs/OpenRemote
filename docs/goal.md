...
* **[`docs/spec/01_PROJECT_STRUCTURE_AND_MONOREPO.md`](spec/01_PROJECT_STRUCTURE_AND_MONOREPO.md)** — Go daemon root, Flutter companion, and CI/CD matrix.
...
* **[`docs/spec/03_AGENT_DRIVERS_SPEC.md`](spec/03_AGENT_DRIVERS_SPEC.md)** — Specialized Go driver interfaces for all 5 target AI coding assistants.
...
* **[`docs/spec/07_DESIGN_SYSTEM.md`](spec/07_DESIGN_SYSTEM.md)** — Zinc/Slate palette, Royal Purple accent (`#7C3AED`), Inter & JetBrains Mono typography, and card components.
